...
namespace margelo::nitro::agesignals {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "AgeRangeResult" and the the Kotlin data class "AgeRangeResult".
   */
  struct JAgeRangeResult final: public jni::JavaClass<JAgeRangeResult> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/agesignals/AgeRangeResult;";
