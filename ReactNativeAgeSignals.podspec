Pod::Spec.new do |s|
  ...
  s.description    = 'Nitro module wrapping Apple DeclaredAgeRange (StoreKit, iOS 17.4+) and Google Play Age Signals to query the app store\'s knowledge of the current user\'s age bracket.'
